...
const handleDealerlogin = async (e) => {  
  ...
  try {  
      await fetch("https://demobackend-hhwe.onrender.com/api/auth/dealer/login", {  
          method: "POST",  
          headers: {  
...
const handleResellerlogin = async (e) => {  
  ...
  try {  
      await fetch("https://demobackend-hhwe.onrender.com/api/auth/reseller/login", {  
          method: "POST",  
          headers: {  
              "Content-Type": "application/json"  
          },  
        ...
        <div className="col-md-6 col-12 col-lg-6 card " style={{height:"360px"}}>  
          <form className='form m-3'> 
            ...
            <div className="row mt-3">
                ...
                <button type="submit" className="btn btn-warning loginButton" onClick={handleDealerlogin}>Dealer Login</button>  
            </div>
                <div className="col-6 text-center">
                <button type="submit" className="btn btn-warning loginButton"  onClick={handleResellerlogin}> Reseller Login</button>  
                </div>
            </div> 
