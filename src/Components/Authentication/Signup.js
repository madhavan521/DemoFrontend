...
const handleDealersignup= async (e) => {  
  ...
  try {  
      await fetch("https://demobackend-hhwe.onrender.com/api/auth/dealer/signup", {  
          method: "POST",  
          headers: {  
...
const handleResellersignup= async (e) => {  
  ...
  try {  
      await fetch("https://demobackend-hhwe.onrender.com/api/auth/reseller/signup", {  
          method: "POST",  
          headers: {  
              "Content-Type": "application/json"  
          },  
     ...
     <div className="row ">
        ...
        {/* Password*/}
            ...
            <div className="row mt-3">
                ...
                <button type="submit" className="btn btn-warning loginButton" onClick={handleDealersignup}>Dealer Signup</button>  
            </div>
                <div className="col-6 text-center">
                <button type="submit" className="btn btn-warning loginButton" onClick={handleResellersignup}> Reseller Signup</button>  
                </div>
            </div> 
