...
const AddUser = () => {  
    ...
    const handleAddUser=(e)=>{
        ...
        try{
        fetch('https://demobackend-hhwe.onrender.com/api/customer/add/create' ,{
            method:"POST",
            headers:{
                        ...
                        <form className='form m-3'>   
                            ...
                            <div className="row mt-3">  
                                <div className="col-6 text-center align-item-start d-flex justify-content-start">  
                                   <Link to='/reseller' className='text-decoration-none'>  <button type="submit" className="btn btn-warning loginButton" >Back To DashBoard</button>  
                               </Link>  </div> 
                                <div className="col-6 text-center align-item-end d-flex justify-content-end">  
                                   <button type="submit" className="btn btn-warning loginButton" onClick={handleAddUser} >Add Customer</button>  
                               </div>  
                            </div>   
